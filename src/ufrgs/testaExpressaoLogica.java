...
public class testaExpressaoLogica {
	...
	public static void main(String args[]){
		...
		ExpressaoLogica pt2 = new ExpressaoOr( new ExpressaoAnd
				(new ExpressaoNot(new ExpressaoAtomica ("B")), new ExpressaoAtomica("C")), 
		...
		System.out.println(teste.eval(valoresVariaveis));
